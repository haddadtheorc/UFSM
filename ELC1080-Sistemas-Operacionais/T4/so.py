...
class SO:
    ...
    def initialize_tasks(self, progr):
        ...
        current_task.initialize(
                0, progr, Memory(50), Internal_State(), IO())
    ...
    def check_alarms(self, clock, cpu):
        if (clock.count == 0):
            return
    ...
    def handle_create(self, cpu, clock):
        ...
        try:
            new_task = Task()
            new_task.initialize(len(self.tasks), self.base_tasks[base_task_id] ,Memory(50), Internal_State(), IO())
